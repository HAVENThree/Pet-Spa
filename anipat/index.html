                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="shoppingcart.html"><i style="font-size: 1.5rem;" class="fas fa-shopping-cart "></i></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/88325793_3095694053991281_8517755738150404096_o.jpg" alt="">
                        </div>
                        <div class="member_name text-center">
                            <div class="mamber_inner">
                                <h4>Nguyen Truong Tho</h4>
                                <p>Senior Director</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/Hinh Ky.jpg" alt="">
                        </div>
                        <div class="member_name text-center">
                            <div class="mamber_inner">
                                <h4>Tran Hoang Ky</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/107966169_1599651746874713_6669049158704045461_o.jpg" alt="">
                        </div>
                        <div class="member_name text-center">
                            <div class="mamber_inner">
                                <h4>Truong Nam Ha Sang</h4>
                                <p>Senior Director</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="contact_text text-center">
                        ...
                        <div class="contact_btn d-flex align-items-center justify-content-center">
                            <a href="contact.html" class="boxed-btn4">Contact Us</a>
                            <p>Or  <a href="tel: +35 752 7322"> +35 752 7322</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                ...
                                <li>+39 605 2731</li>
                                <li>+93 598 0608</li>
                                <li><a href="#">PetSpa@gmail.com</a></li>
                                <li>Lô 14, Đường số 5, Công viên Phần mềm Quang Trung, Q. 12, Tp. HCM, Việt Nam</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3  col-md-6 col-lg-3">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3 ">
                        <div class="footer_widget">
                            ...
                            <p class="address_text">© 2015 SaigonTech is the Official Affiliate of Houston Community College, Texas, US</p>
